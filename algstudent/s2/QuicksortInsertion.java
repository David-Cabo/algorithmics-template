...
/* This program is used to order n elements with a combination of the Quick Sort and Insertion Sort algorithms */
public class QuicksortInsertion {
	...
	public static void quicksortInsertion(int[] a, int left, int right, int k) {
		...
		if (left < right){ //if there is one element it is not necessary
			...
			//if there are 3 elements or fewer, they are already ordered
			if((right - left) <= k) {
